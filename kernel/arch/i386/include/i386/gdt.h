...
#define SEG_SAVL(x)      (x)           // Available for system use
...
struct gdtdesc kgdtdesc[GDT_SIZE];
struct gdtr kgdtr;

void gdt_initialize();
void gdt_add_entry(uint32_t base,uint32_t limit,uint16_t flags, size_t index);
#endif
