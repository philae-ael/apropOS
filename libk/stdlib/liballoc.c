...
#define ALIGN( ptr ){                                       \
        ...
        {                                                   \
            ...
            *((ALIGN_TYPE*)((uintptr_t)ptr - (uintptr_t)ALIGN_INFO)) = \
                (uintptr_t)_diff + (uintptr_t)(ALIGN_INFO);   \
        }                                                   \
    }
...
#define UNALIGN( ptr ){                                  \
        if ( ALIGNMENT > 1 )                             \
        {                                                \
            uintptr_t _diff = (uintptr_t) *((ALIGN_TYPE*) \
                    ((uintptr_t)ptr - ALIGN_INFO));      \
...
static void* liballoc_memcpy(void* s1, const void* s2, size_t n)
{
  ...
  unsigned int *lsrc  = DECONST(unsigned int*, s2);
